...
namespace PIA_PAL
{
    public partial class preguntas_9 : Form
    {
        public preguntas_9()
        {
            InitializeComponent();
            ...
            if (groupBox1.Enabled == true && groupBox2.Enabled == true && groupBox3.Enabled == true && groupBox4.Enabled == true && groupBox5.Enabled == true)
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    else
                    {
                        ...
                        principal.section_9.IconChar = IconChar.CheckCircle;
                        principal.section_9.Enabled = false;
                        principal.section_10.Visible = true;
