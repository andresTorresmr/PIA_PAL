...
namespace PIA_PAL
{
    public partial class preguntas_4 : Form
    {
        public preguntas_4()
        {
            InitializeComponent();
            ...
            if (groupBox1.Enabled == true && groupBox2.Enabled == true && groupBox3.Enabled == true && groupBox4.Enabled == true && groupBox5.Enabled == true)
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    else
                    {
                        ...
                        principal.section_4.IconChar = IconChar.CheckCircle;
                        principal.section_4.Enabled = false;
                        principal.section_5.Visible = true;
