...
namespace PIA_PAL
{
    public partial class preguntas_6 : Form
    {
        public preguntas_6()
        {
            InitializeComponent();
            ...
            if (groupBox1.Enabled == true && groupBox2.Enabled == true && groupBox3.Enabled == true && groupBox4.Enabled == true && groupBox5.Enabled == true)
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    else
                    {
                        ...
                        principal.section_6.IconChar = IconChar.CheckCircle;
                        principal.section_6.Enabled = false;
                        principal.section_7.Visible = true;
