...
namespace PIA_PAL
{
    public partial class preguntas_5 : Form
    {
        public preguntas_5()
        {
            InitializeComponent();
            ...
            if (groupBox1.Enabled == true && groupBox2.Enabled == true && groupBox3.Enabled == true && groupBox4.Enabled == true && groupBox5.Enabled == true)
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    else
                    {
                        ...
                        principal.section_5.IconChar = IconChar.CheckCircle;
                        principal.section_5.Enabled = false;
                        principal.section_6.Visible = true;
