...
namespace PIA_PAL
{
    public partial class preguntas_8 : Form
    {
        public preguntas_8()
        {
            InitializeComponent();
            ...
            if (groupBox1.Enabled == true && groupBox2.Enabled == true && groupBox3.Enabled == true && groupBox4.Enabled == true && groupBox5.Enabled == true)
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    else
                    {
                        ...
                        principal.section_8.IconChar = IconChar.CheckCircle;
                        principal.section_8.Enabled = false;
                        principal.section_9.Visible = true;
